    ...
    <section class="content">
        ...
        <div class="card card-default">
            ...
            <div class="card-body">
                ...
                <?php echo form_open_multipart(base_url('backend/product/create/'), 'class="form-horizontal"') ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" name="wp_name" class="form-control" id="wp_name" required />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" name="merchant_store_url" class="form-control" id="store_url" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="date" name="sale_start_date" class="form-control" id="cost_price" required />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="date" name="sale_end_date" class="form-control" id="cost_price" required />
                    </div>
                </div>
