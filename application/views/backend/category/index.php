            ...
            <div class="card-body table-responsive">
                <table id="na_datatable" class="table table-bordered table-striped" width="100%">
                    ...
                    <tr>
                        ...
                        <th><?= trans('status') ?></th>
                        <th width="40" class="text-right"><?= trans('action') ?></th>
                    </tr>
                    </thead>
                </table>
            </div>
...
<script>
    ...
    var table = $('#na_datatable').DataTable({
        ...
        "columnDefs": [
            ...
            {"targets": 2, "name": "subCategory", 'searchable': false, 'orderable': true},
            {"targets": 3, "name": "is_verify", 'searchable': true, 'orderable': true},
