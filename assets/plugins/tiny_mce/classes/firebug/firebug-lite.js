var firebug = {
    ...
    init: function (_css) {
       ...
       */
            el.content = {};
            el.mainiframe = new lib.element("IFRAME").attribute.set("id", "FirebugIFrame").environment.addStyle({
                "display": "none",
                "width": lib.util.GetViewport().width + "px"
            }).insert(document.body);
            el.main = new lib.element("DIV").attribute.set("id", "Firebug").environment.addStyle({
                "display": "none",
                "width": lib.util.GetViewport().width + "px"
            }).insert(document.body);
            if (!env.isPopup) {
                ...
                with (firebug) {
                    ...
                    for (var key in obj) {
                        try {
                            ...
                            var value = obj[key], property = key,
            ...
            open: function (_index) {
                with (firebug) {
                    ...
                    var script = document.getElementsByTagName("script")[_index],
                        uri = script.src || document.location.href, source;
                    try {
    ...
    pi.util = {
        ...
        Element: {
            ...
            getPosition: function (_element) {
                var parent = _element, offsetLeft = document.body.offsetLeft, offsetTop = document.body.offsetTop,
