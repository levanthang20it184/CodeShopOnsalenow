        ...
        <div class="card">
            <div class="card-header">
                <div class="d-inline-block leftpart">
                    <h3 class="card-title"><i class="fa fa-list"></i>&nbsp; Contact Us Enquiry</h3>
                </div>
                <div class="rightpart">
                    <div class="imp-csv">
                    </div>
...
<script>
    ...
    var table = $('#na_datatable').DataTable({
        "processing": true,
        "serverSide": false,
        "ajax": "<?=base_url('backend/contact/contact_datatable')?>",
        "order": [[0, 'asc']],
        "columnDefs": [
            {"targets": 0, "name": "id", 'searchable': true, 'orderable': true},
            {"targets": 1, "name": "name", 'searchable': true, 'orderable': true},
            {"targets": 2, "name": "contact", 'searchable': true, 'orderable': true},
