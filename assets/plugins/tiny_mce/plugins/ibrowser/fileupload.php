...
<table width="100%" border="0">
    <tr>
        <td align="center"><a href="fileupload.php"><img src="images/img_po.gif" alt='Subir Imagenes' border="0"><br>Subir
                Imagenes</a></td>
        <td align="center"><a href="ibrowser.php"><img src="images/img_in.gif" alt='Insertar Imagenes' border="0"><br>Insertar
                Imagen</a></td>
    ...
    <fieldset>
        ...
        <table>
            <tr>
                ...
                <td style="font-size:x-small">Solo se aceptan archivos de tipo: JPG, GIF o PNG.</td>
            </tr>
            <tr bgcolor="#CCCCCC">
                <td>Avanzado:</td>
                <td>
                    width o height MAX: <input name="width" type="text" style="width: 44px; height: 16px;"/>Px
                </td>
                <td style="font-size:x-small">
                    Solo si sabe para que funciona use este campo. <br>Predeterminado: 230px <br>Usar signo de <b>=</b>
                    para no hacer redimension a la imagen.
                </td>
            </tr>
            <tr>
                <td></td>
                <td align='right'>
                    ...
                    <input name='Submit1' type='submit' value="Cargar..."/></td>
                <td></td>
            </tr>
        </table>
    </fieldset>
