                            ...
                            <div class="Breadcrumb">
                                <ul class="list-unstyled d-flex">
                                    <li style="display: flex">
                                        <a href="#">
                                            <h1 style="margin-bottom: 0; font-size: 13px; font-weight: bold"><?php echo $this->uri->segment(1) ?></h1>
                                        </a>
                                    </li>
                        ...
                        <div class="col-lg-2 col-md-2 col-5">
                            <div class="CompareBtn">
                                <div class="In-Stock-checkbox-box">
                                    <input type="checkbox" class="stock is_stock common_selector" name="is_stock" id="In_Stock" value="">
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-12 col-12 px-0">
                            <div class="FiltersMain">
                                ...
                                <div class="checkBoxFilter">
                                    ...
                                    ?>
                                        <a href="<?php echo base_url(); ?>"><label class="CustomCheck"><?= $value->name; ?><input type="checkbox" name="subcategories" parent="<?= @$category['id']; ?>" id="subcategories_<?php echo $value->id; ?>" class="common_selector subcategories" value="<?= $value->id; ?>" <?php if (@$subcategory_id == $value->id) {
                                                                                                                                                                                                                                                                                                                            echo "checked disabled";
                                                                                                                                                                                                                                                                                                                        } ?> onclick="getTopFIlter();"> <span class="checkmark"></span>(<?php echo isset($count) ? $count : 0 ?>
                                                )
                                            </label></a>
                                    <?php endforeach ?>
                                </div>
                                ...
                                <div class="checkBoxFilter" id="filterBrand">
                                    ...
                                    <div id="brand1">
                                        <?php foreach ($brands as $key => $value) {
                                            $count = chechProductsByBrand($value->id);
                                        ...
                                        ?>
                                            <label class="CustomCheck"><?php echo $value->alias ?>
                                                ...
                                                <input type="checkbox" name="brands" id="brands_<?php echo $value->id; ?>" class="common_selector brands" value="<?= $value->id ?>" onclick="showBrand(<?php echo $value->id ?>)" onclick="getTopFIlter();">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data['product'], function(index, value) {
                    $('.filter_data').append('<div alt="category image" class="col-md-6"><img width="50px" class="div-lazy-loader" data-src="' + value.image + '"><p>' + value.description + '</p></div>')
                });
