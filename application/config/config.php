...
$config['asset_cdn_server'] = "https://onsalenow99.b-cdn.net";
$config['asset_cdn_server_banner'] = "https://onsalenow99.b-cdn.net/uploads/banners/";
$config['assets'] = guess_base_url() . "assets";
$config['images'] = guess_base_url() . "assets/images/";
$config['banner'] = guess_base_url() . "uploads/banners/";
$config['category'] = guess_base_url() . "uploads/category/";
$config['subcategory'] = guess_base_url() . "uploads/subcategory/";
$config['brand'] = guess_base_url() . "uploads/brand/";
$config['product'] = guess_base_url() . "uploads/product/";
// $config['product'] = guess_base_url()."assets/images/";
$config['js'] = guess_base_url() . "assets/js/";
$config['lib'] = guess_base_url() . "assets/lib/";

$config['merchant'] = guess_base_url() . "uploads/merchant/";
