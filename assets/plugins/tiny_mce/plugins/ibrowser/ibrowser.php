...
?>
    ...
    <table width="100%" border="0">
        <tr>
            <td align="center"><a href="fileupload.php"><img src="images/img_po.gif" alt='Subir Imagenes'
                                                             border="0"><br>Subir Imagenes</a></td>
            <td align="center"><a href="ibrowser.php"><img src="images/img_in.gif" alt='Insertar Imagenes'
                                                           border="0"><br>Insertar Imagen</a></td>
            <td align="center"><a href="about.php"><img src="images/ib.gif" alt='Acerca de...' border="0"><br>Acerca
                    de...</a></td>
        </tr>
    </table>
    <hr>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="600">
        <tr>
            <td>
                <div style="width:250px; height:430px; overflow:scroll;">
                    <?php
                    ...
                    <div style="width:350px; height:430px;" align="center">
                        ...
                        <table border="0">
                            <tr>
                                ...
                                <td align="left"><input type="text" disabled="disabled" id="surce" value=""></td>
                            </tr>
                            <tr>
                                <td align="right">Width:</td>
                                <td align="left"><input type="text" disabled="disabled" id="width" value=""></td>
                            </tr>
                            <tr>
                                <td align="right">Height:</td>
                                <td align="left"><input type="text" disabled="disabled" id="height" value=""></td>
                            </tr>
                            <tr>
                                <td align="right">alt:</td>
                                <td align="left"><input type="text" id="alt" value=""></td>
                            </tr>
                            <tr>
                                <td align="right">Border:</td>
                                <td align="left"><input type="text" disabled="disabled" id="border" value=""></td>
                            </tr>
                            <tr>
                                <td colspan="2" align="center">
                                    <button onclick="insertImage('y')">Insertar Imagen</button>
                                </td>
                            </tr>
                        </table>
                    </div>
