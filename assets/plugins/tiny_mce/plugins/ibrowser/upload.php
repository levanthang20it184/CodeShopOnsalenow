...
if (isset($_POST["id"]) and $_POST["id"] != '') {
    ...
    if (is_uploaded_file($filename)) {
        if ($filename4 <> 'image/gif' and $filename4 <> 'image/webp' and $filename4 <> 'image/pjpeg' and $filename4 <> 'image/x-png' and $filename4 <> 'image/jpeg' and $filename4 <> 'image/png') $ferror = "<b>La extencion no es valida '$filename4'.</b>";
        if ($ferror != '') {
