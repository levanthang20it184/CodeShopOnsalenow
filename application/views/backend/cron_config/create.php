        ...
        <div class="card card-default">
            ...
            <div class="card-body table-responsive">
                ...
                <table cellpadding="2" cellspacing="1" bgcolor="#ffffff" width="100%" style="margin-top: 20px">
                    <tbody>
                    <form id="form_create_cron"
                          action="<?php echo base_url('backend/Cron_Config/create_new_cron_job') ?>" method="POST">
                        ...
                        <tr>
                            ...
                            <td height=30>
                                <textarea class="form-control" name="feed_url" id="feed_url" rows="5"
                                          cols="100"></textarea>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <div class="dropdown hierarchy-select" id="brand_select">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btn-brand-select">
                                        ...
                                        <div class="hs-menu-inner">
                                            <a class="dropdown-item" data-value="0" data-default-selected="" href="#">Not
                                                selected</a>
                                            <?php foreach ($merchants as $merchant) : ?>
                                                <a class="dropdown-item" data-value="<?= $merchant['id']; ?>"
                        ...
                        <tr>
                            ...
                            <td height=30>
                                <input type="checkbox" checked name="has_title_line" id="has_title_line">
                            </td>
                        </tr>
...
<script>
                    ...
                    try {
                        ...
                        if (JSON.parse(data)[1] == "error") {
                            ...
                            for (let i = 0; i < maxCnt; i++) {
                                let row = `<tr><td class="column_index">${i + 1}</td><td>${i < titleLineCnt ? getShortenText(titleLine[i]) : ""}</td><td>${i < firstLineCnt ? getShortenText(firstLine[i]) : ""}</td><td>${getOSNColumn()}</td></tr>`;
    ...
    function getOSNColumn() {
        return `<select class="osn-column form-control" style="width: 200px">
            ...
            <option>Product Image URL</option>
            <option>Product Details URL</option>
            <option>Direct Buy Link</option>
            <option>Merchant Price</option>
