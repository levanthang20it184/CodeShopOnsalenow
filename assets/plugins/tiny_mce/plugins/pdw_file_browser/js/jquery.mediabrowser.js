(function ($) {
    ...
    $.MediaBrowser = {
        ...
        init: function () {
            ...
            $('div#navbar ul li:has(ul)').hover(function () {
            }, function (event) {
        ...
        rename: function (path, type) {
            var path_segments, name, old_filename, message, file_segments, file_ext, new_name, prompt_message,
                new_filename;
        ...
        updateFileSpecs: function (path, type) {
            $('div#file-specs #info').load('file_specs.php', {
                'ajax': true,
                'path': urlencode(path),
                'type': type
            }, function () {
