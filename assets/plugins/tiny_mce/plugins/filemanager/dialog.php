                ...
                <div class="span8 pull-right">
                    <?php if ($_GET['type'] == 2 || $_GET['type'] == 0) { ?>
                        <div class="pull-right"><?php echo lang_Filter; ?> :
                            <input id="select-type-6" name="radio-sort" type="radio" data-item="ff-item-type-6"
                                   class="hide"/>
                            <label id="ff-item-type-6" for="select-type-6"
                                   class="btn  ff-label-type-6"><?php echo lang_doc; ?></label>
                ...
                <ul class="grid cs-style-2">
                                            ...
                                            <figcaption>
                                                <form action="force_download.php" method="post" class="download-form"
                                                    ...
                                                    <input type="hidden" name="path"
                                                           value="<?php echo $root . $cur_dir . $file ?>"/>
                                                    <input type="hidden" name="name" value="<?php echo $file ?>"/>

                                                    <a title="<?php echo lang_Download ?>" class=""
                    ...
                    <li class="ff-item-type-6 fullwidth" style="display:none;">
                        <div id="Instruction">
                            ...
                            <p class="point">2.</p>
                            <p> Place the Iframe share code from youtube/ Vimeo in the <strong> Embed </strong>tab and
                                press ok.</p>
                            <p class="point">3.</p>
                            <p> You can also upload the video using the source icon on the right side of souce field
                                under <strong> General</strong> Tab.</p>
                            <h5>To Embed Link</h5>
                            <p class="point">1.</p>
